            ...
            <form name="balanceSheetForm" action="javascript:void(0)" style="display:flex; width:100%" class="row" confirm-on-exit>
                <div class="col-md-12 mt-2" ng-show="is_admin">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <md-select md-no-asterisk  name="hotel_id" class="m-0" ng-model="balance_sheet.hotel_id" placeholder="Select a Hotel ">
                ...
                <div class="text-right mt-3 col-md-8">
                    <button ng-click="balance_sheet()" type="button" class="btn bg-success srch-rooms legitRipple"><i class="icon-paperplane mr-1"></i>Search Balance Sheet</button>
