...
@section('scripts')
    <script src="app/balancesheet-controller.js"></script>
...
<div id="main-content" class="content" ng-controller='balanceSheetCtrl' ng-init='init()'>
    <div class="m-auto">
		@include('balance_sheet.search')
    </div>
