...
@section('scripts')
    <script src="app/rooms-controller.js"></script>
@endsection

@section('content')


<div class="content" ng-controller='roomsCtrl' ng-init='init()'>
    <div class="m-auto">
        @include('rooms.form')
    </div>
					...
					<div class="card-header header-elements-inline">
						...
						<div class="header-elements">
							<div class="list-icons">
								<button type="button" class="btn btn-sm btn-primary " ng-click="createRoom()"><i class="mr-1 icon-plus22"></i>Add New room</button>
