            ...
            <div style="border: 1px dotted;padding: 10px;" class="dotted-border">
                ...
                <div style="display: flex; align-items: center" ng-cloak ng-repeat="colCriteria in searchGroup" class="form-group row">
                    ...
                    <div class="col-lg-3">
                        ...
                        <select ng-if="colCriteria.column.type == 'date'" ng-change="check(colCriteria)" ng-model="colCriteria.operator" placeholder="Select an operator" class="form-control">
                            <option value="" selected="true" disabled="true">Select an operator</option>
                            <option value=">">Greater than</option>
                            <option value="<">Less than</option>
                            <option value="=">Equals</option>
                    ...
                    <div class="col-lg-3">
                        <input ng-cloak placeholder="Type [[colCriteria.column.alias]] value to be filtered" ng-if="colCriteria.column.type != 'enum'  && colCriteria.column.type != 'date'" id="colInput" type="[[ (colCriteria.column.type == 'number' || colCriteria.column.type == 'float' || colCriteria.column.type == 'amount') ? 'number' : 'text' ]]" ng-model="colCriteria.value" class="form-control  [[ colCriteria.column.type == 'time' ? 'pickatime' : '' ]]">
                        <input ng-cloak placeholder="Click to filter date for [[colCriteria.column.alias]]" ng-if="colCriteria.column.type == 'date' && colCriteria.operator != '=='" id="colInput" type="text" ng-model="colCriteria.value" class="form-control pickadate">
