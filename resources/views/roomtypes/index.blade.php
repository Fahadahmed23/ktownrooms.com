...
@section('scripts')
    <script src="app/roomtypes-controller.js"></script>
@endsection

@section('content')


<div class="content" ng-controller='roomtypesCtrl' ng-init='init()'>
    <div class="m-auto">
        @include('roomtypes.form')
    </div>
    <div class="d-md-flex admin-panel-section align-items-md-start">
        <!-- Left sidebar component -->
        @include('roomtypes.filter')
        <!-- /left sidebar component -->
					...
					<div class="card-header header-elements-inline">
						...
						<div class="header-elements">
							<div class="list-icons">
								<button type="button" class="btn btn-sm btn-primary " ng-click="createRoomType()"><i class="mr-1 icon-plus22"></i>Add New company</button>
