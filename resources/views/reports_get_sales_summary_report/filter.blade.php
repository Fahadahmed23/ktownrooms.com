            ...
            <div class="card-body">
                <form>
                    ...
                    <div class="float-right">
                        <button class="btn btn-default float-right" ng-click="filterData_sale_summary(searchReportingAttributes, 'clear')"  type="reset">Reset</button>
                        <button class="btn btn-primary float-right" ng-click="filterData_sale_summary(searchReportingAttributes)">Filter</button>
                    </div>
                </form>
            </div>
        </div>
