...
<div class="content" ng-controller='reportCtrl' ng-init='getsummaryReport()'>

    <div class="d-md-flex admin-panel-section align-items-md-start">
        <!-- Left sidebar component -->
        @include('reports_get_sales_summary_report.filter')
        <!-- /left sidebar component -->
        <!-- datatable component -->
        ...
        <div class="flex-fill overflow-auto">
            ...
            @include('reports_get_sales_summary_report.table')
