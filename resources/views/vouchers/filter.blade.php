        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="floating-label"> 
                  <input ng-model="searchVoucherNo" type="text" maxlength="50" class="form-control" placeholder=" ">
                ...
                <div class="floating-label"> 
                    <input ng-model="SearchVoucherTypeName" type="text" maxlength="50" class="form-control alphabets" placeholder=" ">
                    <span class="highlight"></span>
