                                        ...
                                        <table>
                                            <tr>
                                                <td valign="top" style="text-align: center; padding: 60px 0 10px 20px;">
                                                    <h4 style="margin: 0; font-family: 'Montserrat', sans-serif;   color: #ffffff; font-weight: bold;">We have received a password reset request for your KTown account</h4>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td valign="top" style="text-align: center; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #fff;">
                                                    ...
                                                    <p>Dear {{$user->name}}, your password on
                                                        <a style="color:#fff;" href="{{site_url()}}">Ktown</a> is : {{$password}}</p>
                                                </td>
                                            </tr>
                                            <tr>
