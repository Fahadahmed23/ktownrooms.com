...
@section('scripts')
    <script src="app/ledger-controller.js"></script>
...
<div id="main-content" class="content" ng-controller='ledgerCtrl' ng-init='init()'>
    <div class="m-auto">
		@include('ledgers.search')
    </div>
        ...
        <div class="flex-fill overflow-auto">
				<div class="card">
					...
					<div class="card-header header-elements-inline">
						<h5 class="card-title">General Ledger
							{{-- <span>
