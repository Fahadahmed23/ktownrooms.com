...
@section('content')
<!-- Page content -->
<div class="page-content" ng-controller="reportCtrl" ng-init="init()">
   ...
   <div class="content-wrapper">
      ...
      <div class="content">
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <div class="card">
                              ...
                              <div class="card-body">
                                 @include('report.edit-criteria-tab-modal')
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <div class="card">
                              ...
                              <div class="card-body">
                                 @include('report.edit-tab-columns-modal')
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <div class="card">
                              ...
                              <div class="card-body">
                                 @include('report.edit-tab-grouped-columns-modal')
                     ...
                     <div style="margin-top: 15px;;" class="row">
                        ...
                        <div class="col-md-6">
                           <div class="card">
                              ...
                              <div style="height: 515px;overflow-y:auto;" class="card-body previewSection">
                                 <p>This report will display the following columns</p>
                                 <ul>
         ...
         @include('report.edit-columns-modal')
         @include('report.edit-grouped-columns-modal')
         @include('report.edit-aggregate-modal')
