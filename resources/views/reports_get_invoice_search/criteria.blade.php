...
<div class="page-content" ng-controller="reportsCtrl" ng-init="init()">
   ...
   <div class="content-wrapper">
      ...
      <!-- Page header -->
      @include('reports_get_invoice_search.header')
      <!--/page header-->
      <!-- Content area -->
      <div class="content">
         <ul class="stepper">
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <div class="card">
                              ...
                              <div class="card-body">
                                 @include('reports_get_invoice_search.edit-criteria-tab-modal')
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <div class="card">
                              ...
                              <div class="card-body">
                                 @include('reports_get_invoice_search.edit-tab-columns-modal')
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <div class="card">
                              ...
                              <div class="card-body">
                                 @include('reports_get_invoice_search.edit-tab-grouped-columns-modal')
         ...
         @include('reports_get_invoice_search.edit-columns-modal')
         @include('reports_get_invoice_search.edit-grouped-columns-modal')
         @include('reports_get_invoice_search.edit-aggregate-modal')
