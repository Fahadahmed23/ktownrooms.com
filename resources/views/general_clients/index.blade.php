...
@section('scripts')
    <script src="app/generalclients-controller.js"></script>
@endsection

@section('content')


<div id="main-content" class="content" ng-controller='generalclientsCtrl' ng-init='init()'>
    <div class="m-auto">
        @include('general_clients.form')
    </div>


    <div class="d-md-flex admin-panel-section align-items-md-start">
        <!-- Left sidebar component -->
        @include('general_clients.filter')
		@include('general_clients.clients_modal')
        <!-- /left sidebar component -->
        <div class="flex-fill overflow-auto">
				<div class="card">

					<div class="card-header header-elements-inline">
						<h5 class="card-title">General Clients
							<span>
