                  ...
                  <div class="row row m-0 p-2 bg-light">
                    ...
                    <div class="col-md-6">  
                      <div class="form-group">
                        ...
                        <input type="text" date placeholder="MM/DD/YYYY" class="form-control pickadate" ng-model="purchase_order.purchase_date" name="purchase_date" id="PurchaseDate" required>
                  ...
                  <div class="col-md-12">
                    <table class="table table-user table-striped hover display datatable-basic table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr ng-repeat="purchase_order in products track by $index" class="pro_row">
                          <td>
                            <md-select md-no-asterisk ng-change="getProDetail(purchase_order.inventory_id, purchase_order, $index)" name="inventory_id" class="m-0" ng-model="purchase_order.inventory_id" placeholder="Select a Product" required>
                          ...
                          <td>
                            <input ng-disabled="!purchase_order.inventory_id" type="text" number data-type="number_format" ng-change="calculateUnitPrice(purchase_order.Quantity,$index)" name="Quantity" ng-model="purchase_order.Quantity" class="form-control num3 px-2 inv_Quantity" placeholder="1" required>
                          </td>
                          <td>
