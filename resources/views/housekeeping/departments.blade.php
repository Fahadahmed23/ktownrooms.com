<div ng-repeat="department in departments" class="kt-kitchen kt col-md-4 text-center" style="background-image: url(http://localhost:8000/global_assets/images/backgrounds/panel_bg.png); background-size: contain;">
    <div ng-click="createServiceRequest(department.id)" class="card [[department.bg_color]] text-white" style="cursor: pointer; background-color:[[department.bg_color]];">
