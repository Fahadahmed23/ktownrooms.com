...
@section('scripts')
    <script src="app/relations-controller.js"></script>
@endsection

@section('content')


<div class="content" ng-controller='relationsCtrl' ng-init='init()'>
    <div class="m-auto">
        @include('relations.form')
    </div>
					...
					<div class="card-header header-elements-inline">
						...
						<div class="header-elements">
							<div class="list-icons">
								<button type="button" class="btn btn-sm btn-primary " ng-click="createRelation()"><i class="mr-1 icon-plus22"></i>Add New Relation</button>
