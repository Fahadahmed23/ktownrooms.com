        ...
        <div class="card">
            ...
            <div class="card-body"> 
                ...
                <div class="floating-label"> 
                    <input ng-model="searchName" type="text" class="form-control alphabets" maxlength="50" placeholder=" ">
                    <span class="highlight"></span>
                    <label>Department Title </label> 
                </div>
                <div class="floating-label"> 
                    <input ng-model="searchCompany" type="text" class="form-control alphabets" maxlength="50" placeholder=" ">
                    <span class="highlight"></span>
