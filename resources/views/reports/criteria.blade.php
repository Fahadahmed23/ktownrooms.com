...
<div class="page-content" ng-controller="reportsCtrl" ng-init="init()">
   ...
   <div class="content-wrapper">
      ...
      <div class="content">
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <div class="card">
                              ...
                              <div class="card-body">
                                 @include('reports.edit-criteria-tab-modal')
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <div class="card">
                              ...
                              <div class="card-body">
                                 @include('reports.edit-tab-columns-modal')
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <div class="card">
                              ...
                              <div class="card-body">
                                 @include('reports.edit-tab-grouped-columns-modal')
         ...
         @include('reports.edit-columns-modal')
         @include('reports.edit-grouped-columns-modal')
         @include('reports.edit-aggregate-modal')
