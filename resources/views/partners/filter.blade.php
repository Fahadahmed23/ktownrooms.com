        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="floating-label"> 
                  <input ng-model="searchPartner" type="text" maxlength="50" class="form-control alphabets" placeholder=" ">
                ...
                <div class="floating-label"> 
                    <input ng-model="searchHotel" type="text" maxlength="50" class="form-control alpha_numeric" placeholder=" ">
                    <span class="highlight"></span>
                    <label>Hotel</label> 
                </div>
