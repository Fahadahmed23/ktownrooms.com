...
class CreateItemstocktransfersTable extends Migration {
	...
	public function up()
	{
		Schema::create('itemstocktransfers', function(Blueprint $table)
		{
			$table->integer('id', true);
			$table->integer('ItemCategoryCode');
			$table->integer('ItemCode');
			$table->integer('FromDepartmentCode');
			$table->integer('ToDepartmentCode');
	...
	{
		Schema::drop('itemstocktransfers');
	}
