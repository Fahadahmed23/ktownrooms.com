...
class SpGetIncomeStatement extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        $procedure = "
            CREATE PROCEDURE `GetIncomeStatement`(LevelNoSent INT, FiscalYearMasterID INT,FromDate DATE, ToDate DATE, HotelId INT)
            BEGIN
