...
class SpAutoPostExtend extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        $procedure = "
            CREATE PROCEDURE `AutoPostExtend`(b_id INT, amt INT, u_id INT)
            BEGIN
                ...
                SET @narration = 'Booking Extension charges for ';                                                                                                                                                                                   
                
                -- Get account_auto_posting_type.id for checkedin
                SET @type_id = (SELECT id FROM account_auto_posting_type a WHERE a.is_active = 1 AND a.title='booking extended' LIMIT 1);
        ...
        DB::unprepared("DROP procedure IF EXISTS AutoPostExtend");
