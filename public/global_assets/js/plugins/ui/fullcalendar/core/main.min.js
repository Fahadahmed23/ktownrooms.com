...
! function(e, t) {
    ...
    function t(e, t, n) {
        ...
        if (t)
            for (var i in t) "style" === i ? g(r, t[i]) : ci[i] ? r[i] = t[i] : r.setAttribute(i, t[i]);
    ...
    function Vt(e, t) {
        return "object" == typeof e && e ? ("string" == typeof t && (e = Di({
            separator: t
        }, e)), new ki(e)) : "string" == typeof e ? new Oi(e, t) : "function" == typeof e ? new _i(e) : void 0
    }
    ...
    function hn(e, t, n, r) {
        var i = e.eventDrag,
            ...
            a = o.defs,
            s = o.instances,
            u = Jt(a, i.isEvent ? e.eventUiBases : {
                "": t.selectionConfig
            });
        r && (u = it(u, r));
    ...
    function nr(e) {
        ...
        for (var s = r.length ? r[0].code : "en", u = {
                en: vo
            }, l = 0, c = r.concat(t); l < c.length; l++) {
            var d = c[l];
            u[d.code] = d
        }
        return {
    ...
    function Yr(e, t) {
        var n;
        return n = /^(year|month)$/.test(e.currentRangeUnit) ? e.currentRange : e.activeRange, this.dateEnv.formatRange(n.start, n.end, Vt(t.titleFormat || qr(e), t.titleRangeSeparator), {
    ...
    function ui(e, t, n, r, i, o, a, s) {
        ...
        return u = "function" == typeof f.columnHeaderHtml ? f.columnHeaderHtml(c.toDate(e)) : Dn("function" == typeof f.columnHeaderText ? f.columnHeaderText(c.toDate(e)) : c.format(e, i)), n ? h = h.concat(Fn(e, t, o, !0)) : h.push("fc-" + yi[e.getUTCDay()]), '<th class="' + h.join(" ") + '"' + (p && n ? ' data-date="' + c.formatIso(e, {
            omitTime: !0
    ...
    var Qi = function(e) {
        ...
        return tt(t, e), t.prototype.destroy = function() {
            ...
            if (n)
                for (var i in r)
                    if (!bt(n.validRange, r[i].range)) return !1;
            return cn(e, t)
        ...
        go = function() {
            ...
            return e.prototype.add = function(e, t) {
                ...
                var e = Ye(this.dynamicOverrides.locales, this.overrides.locales, co.locales),
                    t = Ye(this.dynamicOverrides.locale, this.overrides.locale, co.locale),
                    n = nr(e),
    ...
    var Eo = /^\s*\d{4}-\d\d-\d\d([T ]\d)?/,
        ...
        ko = function(e) {
            function n(n, r) {
                var i = e.call(this, n) || this;
                i._renderToolbars = Ln(i.renderToolbars), i.buildViewPropTransformers = Mt(Gr), i.el = r, s(r, i.contentEl = t("div", {
            ...
            return tt(n, e), n.prototype.destroy = function() {
                ...
                o ? (this.header || (this.header = new Mo(this.context, "fc-header-toolbar"), s(this.el, this.header.el)), this.header.receiveProps(Di({
                    layout: o
                }, p))) : this.header && (this.header.destroy(), this.header = null), u ? (this.footer || (this.footer = new Mo(this.context, "fc-footer-toolbar"), a(this.el, this.footer.el)), this.footer.receiveProps(Di({
                    layout: u
    ...
    var No = function() {
        ...
        return Object.defineProperty(e.prototype, "view", {
            ...
            e = String(e);
            for (var n in t)
                if (t[n].publicId === e) return new Pi(this, t[n]);
            return null
    ...
    var zo = function(e) {
        ...
        return tt(n, e), n.prototype.initialize = function() {}, Object.defineProperty(n.prototype, "activeStart", {
            get: function() {
            ...
            return {}
        }, n.prototype.applyDateScroll = function(e) {}, n
    }(Qi);
