...
! function(e, t) {
        ...
        h = function(e) {
            ...
            return r(n, e), n.prototype.renderSegHtml = function(e, r) {
                var n, i, o = this.context.options,
                    ...
                    k=""
                    ;
                    k=l.extendedProps.html;
                    
                    
    
                return u.unshift("fc-day-grid-event", "fc-h-event"), e.isStart && (n = this.getTimeText(s)) && (g = '<span class="fc-time">' + t.htmlEscape(n) + "</span>"), i = '<span class="fc-title">' + (k==undefined?(t.htmlEscape(l.title || "") || "&nbsp;"):k)  + "</span>", '<a class="' + u.join(" ") + '"' + (l.url ? ' href="' + t.htmlEscape(l.url) + '"' : "") + (f ? ' style="' + f + '"' : "") + '><div class="fc-content">' + ("rtl" === o.dir ? i + " " + g : g + " " + i) + "</div>" + (h ? '<div class="fc-resizer fc-start-resizer"></div>' : "") + (p ? '<div class="fc-resizer fc-end-resizer"></div>' : "") + "</a>"
    ...
    e.default = D, e.SimpleDayGrid = E, e.DayGridSlicer = R, e.DayGrid = w, e.AbstractDayGridView = C, e.DayGridView = H, e.buildBasicDayTable = s, e.DayBgRow = y, Object.defineProperty(e, "__esModule", {
        value: !0
    })
});