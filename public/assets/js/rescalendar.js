    ...
    $.fn.rescalendar = function(options) {
            ...
            function setDayCells(targetObj, refDate) {
                ...
                var format = settings.format,
                    ...
                    html = '<td class="firstColumn d-none"></td>',
                    f_aux = '',
                    f_aux_format = '',
                    dia = '',
                    dia_semana = '',
            ...
            var settings = $.extend({
                ...
                template_html: function(targetObj, settings) {
                    ...
                    return [
                        ...
                        '<table class="rescalendar_table mt-3">',
                        '<thead>',
                        '<tr class="rescalendar_day_cells"></tr>',
                        '</thead>',
                        '<tbody class="rescalendar_data_rows">',
                        '<td>',
                        '<button class="move_to_last_month btn btn-"> << </button>',
                        '<button class="move_to_yesterday btn"> < </button>',
                        '</td>',
                        '</tbody>',
                        '</table>',
                        '<div class="rescalendar_controls mb-5 my-3">',

                        '<button class="move_to_last_month btn mx-1 btn-info"> << </button>',
                        '<button class="move_to_yesterday btn mx-1 btn-info"> < </button>',

                        '<input class="refDate " type="date" value="' + refDate + '" />',

                        '<button class="move_to_tomorrow btn mx-1 btn-info"> > </button>',
                        '<button class="move_to_next_month btn mx-1 btn-info"> >> </button>',

                        '<br>',
                        '<button class="move_to_today btn btn-success"> ' + settings.lang.today + ' </button>',
