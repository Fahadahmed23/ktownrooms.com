                ...
                _createClass(Iti, [{
                    ...
                    value: function _updatePlaceholder() {
                        ...
                        if (window.intlTelInputUtils && shouldSetPlaceholder) {
                            ...
                            // var placeholder = intlTelInputUtils.getExampleNumber(this.selectedCountryData.iso2, this.options.nationalMode, numberType)
                            ...
                            // $(this.telInput).mask(placeholder)
                        }
                    }
                }, {
                    key: "_selectListItem",
...
$(document).ready(function() {
    var phoneInputID = "#phone_int";
    var input = document.querySelector(".phone_int");
